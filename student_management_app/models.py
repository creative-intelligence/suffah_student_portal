...
def create_user_profile(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        if instance.user_type == 3:
            Students.objects.create(admin=instance, course_id=Courses.objects.get(id=7), session_year_id=SessionYearModel.objects.get(id=1), address="", profile_pic="", gender="")
