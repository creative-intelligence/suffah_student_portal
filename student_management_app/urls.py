...
from . import views
from .import HodViews, StaffViews, StudentViews, homeViews
...
urlpatterns = [
    ...
    path('staff_view_all_assignments/', StaffViews.staff_view_all_assignments, name="staff_view_all_assignments"),
    path('staffDownloadAssignment/<assignment_id>', StaffViews.staffDownloadAssignment, name="staffDownloadAssignment"),
    ...
    path('staff_notice_board/', StaffViews.staff_notice_board, name="staff_notice_board"),
    ...
    path('student_upload_assignment/<assignment_id>', StudentViews.student_upload_assignment, name="student_upload_assignment"),
